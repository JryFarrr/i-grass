...
const TICKER_ITEMS = Array.from({ length: 12 });
    ...
    <>
      <section id="home" className="relative min-h-[85vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            {/* Left: Text */}
            <div>
              <div className="badge-glass mb-6 hero-rise">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 hero-rise hero-rise-delay-sm">i-Gras</h1>
              <p className="text-soft text-lg leading-relaxed max-w-xl mb-10 hero-rise hero-rise-delay-md">
              ...
              <div className="flex flex-wrap items-center gap-3 hero-rise hero-rise-delay-lg">
              ...
              {/* Social icons */}
              <div className="mt-8 flex items-center gap-5 text-soft hero-rise hero-rise-delay-xl">
            ...
            <div className="relative hidden lg:block hero-rise hero-rise-delay-md">
              <AGSVisual />
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 py-8 overflow-hidden">
        <div className="relative left-1/2 w-screen -translate-x-1/2">
          <div className="ticker glass px-6 sm:px-10 md:px-14 lg:px-16 hero-rise hero-rise-delay-md">
            <div className="ticker-track">
              {TICKER_ITEMS.map((_, index) => (
                <span key={`ticker-primary-${index}`} className="ticker-item">
                  <span className="ticker-dot" aria-hidden="true" />
                  I-Gras
                </span>
              ))}
              {TICKER_ITEMS.map((_, index) => (
                <span key={`ticker-duplicate-${index}`} className="ticker-item">
                  <span className="ticker-dot" aria-hidden="true" />
                  I-Gras
                </span>
              ))}
